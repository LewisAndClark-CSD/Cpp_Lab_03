...
void player_turn()
{
	...
	default:
		cout << "You didn't get a correct number! Try again\n";
		player_turn();
	}
	...
	{
		cout << "That space is taken up already! Please try again.";
		player_turn();
	}
...
bool gameover()
{
	for (int i = 0; i < 3; i++)//Getting a win
	{
	...
	for (int i = 0; i < 3; i++)//Getting a tie
	{
		for (int j = 0; j < 3; j++)
		{
